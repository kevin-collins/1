...
class Login:
    def __init__(self, username, password):
        ...
        self.header = {
            'Host':'login.hdu.edu.cn',
            'Referer':'http://login.hdu.edu.cn/srun_portal_pc?ac_id=18&theme=pro',
...
def arg_parse():
    ...
    parser.add_argument('username', help='HDU Student Number', nargs='?', default='202050215')
    parser.add_argument('password', help='HDU Account Password', nargs='?', default='Lizhihao97')
